...
import webscraping.model.character.CharInfo;
    ...
    public static CharInfo getInfoBase(Document doc) throws IOException {
        ...
        if (!imageElements.isEmpty()) {
            for (Element image : imageElements) {
                ...
                images.add(Converters.getBase64Image(urlImage.substring(0, urlImage.indexOf("/revision")) + "/revision" +
                        "/latest/scale-to-width-down/600"));
            }
